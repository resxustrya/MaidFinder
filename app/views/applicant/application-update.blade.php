                        ...
                        <div class="row">
                            ...
                            <div class="col s12 m12 l6">
                                <table border="0" class="other_duties">
                                    <tr>
                                        <td>
                                            <input type="checkbox" id="test5" name="cooking" value="Cooking" {{ (isset($duties->cooking) and $duties->cooking != null) ? 'checked' : '' }}/>
                                            <label for="test5">Cooking</label>
                                        </td>
                                        <td>
                                            <input type="checkbox" id="test6" name="laundry" value="Laundry" {{  (isset($duties->laundry) and $duties->laundry != null) ? 'checked' : '' }}/>
                                            <label for="test6">Laundry</label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <input type="checkbox" id="test7" name="gardening" value="gardening" {{ (isset($duties->gardening) and $duties->gardening != null) ? 'checked' : '' }}/>
                                            <label for="test7">Gardening</label>
                                        </td>
                                        <td>
                                            <input type="checkbox" id="test8" name="grocery" value="Grocery" {{ (isset($duties->grocery) and $duties->grocery != null) ? 'checked' : '' }}/>
                                            <label for="test8">Grocery</label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <input type="checkbox" id="test9" name="cleaning" value="House Cleaning" {{ (isset($duties->cleaning) and $duties->cleaning != null) ? 'checked' : '' }}/>
                                            <label for="test9">House cleaning</label>
                                        </td>
                                        <td>
                                            <input type="checkbox" id="test10" name="tutoring" value="Tutoring" {{ (isset($duties->tuturing) and $duties->tuturing != null) ? 'checked' : '' }}/>
                                            <label for="test10">Tutoring</label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <input type="checkbox" id="test11" name="driving" value="Driving" {{ (isset($duties->driving) and  $duties->driving != null) ? 'checked' : '' }}/>
                                            <label for="test11">Driving</label>
                                        </td>
                                        <td>
                                            <input type="checkbox" id="test12" name="pet" value="Pet Care" {{ (isset($duties->pet) and $duties->pet != null) ? 'checked' : '' }}/>

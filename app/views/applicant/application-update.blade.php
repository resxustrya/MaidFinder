            ...
            <div class="card-header">
                <h2>Job Preferences Information
                    ...
                    @if(Session::has('message'))
                        <h5 class="has-warning">{{ Session::get('message') }}</h5>
                    @endif
                </h2>
            </div>

            <div class="card-body card-padding">
                <form action="{{ asset('/applicant/job/application/edit') }}" method="POST" role="form">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            ...
                            <label class=" c-red" for="jobtype">{{ isset($error)? $error->first('position') : '' }}</label>
                            <div class="form-group">
                                <div class="fg-line select">
                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="form-group">
                                ...
                                {{ $application->pitch != null ? $application->pitch : '' }}
                                </textarea>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-12">
                            ...
                            <label class="checkbox checkbox-inline m-r-20">
                                <input type="checkbox" value="laundry" {{  (isset($duties->laundry) and $duties->laundry != null) ? 'checked' : '' }}/>
                                <i class="input-helper"></i>
                                Laundry
                            </label>
                            <label class="checkbox checkbox-inline m-r-20">
                                <input type="checkbox" name="cooking" value="Cooking"{{ (isset($duties->cooking) and $duties->cooking != null) ? 'checked' : '' }}/>
                                <i class="input-helper"></i>
                                Cooking
                            </label>
                            <label class="checkbox checkbox-inline m-r-20">
                            ...
                            <label class="checkbox checkbox-inline m-r-20">
                                <input type="checkbox" name="grocery" value="Grocery"{{ (isset($duties->grocery) and $duties->grocery != null) ? 'checked' : '' }}/>
                                <i class="input-helper"></i>
                                Grocery
                            </label>
                            <label class="checkbox checkbox-inline m-r-20">
                                <input type="checkbox" name="cleaning" value="House Cleaning"{{ (isset($duties->cleaning) and $duties->cleaning != null) ? 'checked' : '' }}/>
                                <i class="input-helper"></i>
                                House Cleaning
                            </label>
                            <label class="checkbox checkbox-inline m-r-20">
                                <input type="checkbox" name="tutoring" value="Tutoring"{{ (isset($duties->tuturing) and $duties->tuturing != null) ? 'checked' : '' }}/>
                                <i class="input-helper"></i>
                                Tutoring
                            </label>
                            <label class="checkbox checkbox-inline m-r-20">
                                <input type="checkbox" name="driving" value="Driving" {{ (isset($duties->driving) and  $duties->driving != null) ? 'checked' : '' }}/>
                                <i class="input-helper"></i>
                                Driving
                            </label>
                            <label class="checkbox checkbox-inline m-r-20">
                                <input type="checkbox" name="pet"value="Pet Care"{{ (isset($duties->pet) and $duties->pet != null) ? 'checked' : '' }}/>
                                <i class="input-helper"></i>
                                Pet Care
                            </label>

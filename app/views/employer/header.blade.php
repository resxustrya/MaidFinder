<header id="header" class="clearfix" data-ma-theme="blue">
    <ul class="h-inner">
        ...
        <li class="hi-logo hidden-xs">
            <a href="{{asset('/')}}" class="m-l-10">
                <img height="35"src="{{ asset('public/images/icon4.png') }}" alt="MaidFinderLogo">
                MaidFinderPH
            </a>
        </li>
        ...
        <li class="pull-right">
            <ul class="hi-menu">
                <li>
                    <a href="{{ asset('employer/home') }}"><span class="him-label">Home</span></a>
                </li>
                <li><a href="#"><span class="him-label">Subscription</span></a></li>
                        ...
                        <div class="list-group">
                            ...
                            <div class="lg-body">
                                <a class="list-group-item media" href="">
                                    <div class="pull-left">
                                        <img class="lgi-img" src="{{asset('public/template/img/profile-pics/1.jpg')}}" alt="">
                                    </div>
                                ...
                                <a class="list-group-item media" href="">
                                    <div class="pull-left">
                                        <img class="lgi-img" src="{{asset('public/template/img/profile-pics/2.jpg')}}" alt="">
                                    </div>
                                    <div class="media-body">
                                ...
                                <a class="list-group-item media" href="">
                                    <div class="pull-left">
                                        <img class="lgi-img" src="{{asset('public/template/img/profile-pics/4.jpg')}}" alt="">
                                    </div>
                                    <div class="media-body">
                    ...
                    <div class="dropdown-menu dropdown-menu-lg pull-right">
                        <div class="list-group him-notification">
                            ...
                            <div class="lg-body">
                                ...
                                <a class="list-group-item media" href="">
                                    <div class="pull-left">
                                        <img class="lgi-img" src="{{asset('public/template/img/profile-pics/3.jpg')}}" alt="">
                                    </div>
                                    <div class="media-body">
                                        <div class="lgi-heading">Fredric Mitchell Jr.</div>
                                        <small class="lgi-text">Phasellus a ante et est ornare accumsan at vel magnauis blandit turpis at augue ultricies</small>
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dm-icon pull-right">
                        ...
                        <li>
                            <a href="#"><i class="zmdi zmdi-settings"></i> Abusive Report</a>
                        </li>
                        <li>
                            <a href="{{ asset('/employer/profile') }}"><i class="zmdi zmdi-face"></i> Profile Settings</a>
                        </li>
                        <li>
                            <a href="{{ asset('employer/logout') }}"><i class="zmdi zmdi-power"></i>Logout</a>
                        </li>
                    </ul>
                </li>
            </ul>
